...
public class DataSourceBasedMultiTenantConnectionProvider extends AbstractDataSourceBasedMultiTenantConnectionProviderImpl {
    ...
    private static final Logger log = LoggerFactory.getLogger(DataSourceBasedMultiTenantConnectionProvider.class);
    
    private final String DEFAULT_TENANT_ID = OpenmrsConstants.DATABASE_NAME;
    ...
    private DataSource getConnectionProvider(String name) {
